...
import cl.caserita.wms.out.helper.IntegracionCambioEstadoHelper;
...
import cl.caserita.wms.out.helper.IntegracionConfirmacionASNHelper;
@Path("/wmsCaserita")

public class servicioCaseritaXMLWMS {
	...
	public static void main (String []args){
		String nombre ="<INVENTORY_RECEIPT_IFD_VC>";
		int numero = "<INVENTORY_RECEIPT_IFD_VC>".indexOf(nombre);
		if ("<INVENTORY_RECEIPT_IFD_VC>".indexOf(nombre)!=-1){
			log.info(numero);
		}
	}
}
