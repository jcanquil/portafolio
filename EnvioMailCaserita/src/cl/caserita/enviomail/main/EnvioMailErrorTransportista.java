...
public class EnvioMailErrorTransportista {
	
	public void mail(String tipo, int numeroCarg, String mensaje, String jotason){
		...
		try{
			...
			message.setSubject("** ERROR PEDIDO QUADMINDS **");
