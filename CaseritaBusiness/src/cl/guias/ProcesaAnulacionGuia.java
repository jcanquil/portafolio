...
public class ProcesaAnulacionGuia {
	...
	public static void main (String[]args){
		...
		archivoLog=prop.getProperty("urlServletAnulaGuia")+"?numGuia="+numDoc+"&"+"rutEmpresa="+rut;
		System.out.println("Procesa Servlet Anulacion Guia:"+archivoLog);
